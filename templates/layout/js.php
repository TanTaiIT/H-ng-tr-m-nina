...
<?php if($source=='index'){?>
    ...
    <script>
        $('.rundt').slick({
            ...
            slidesToScroll: 4, autoplay:true,  autoplaySpeed:3000, speed:1000, arrows:false, 
            centerMode:false,  dots:false,  draggable:true, variableWidth:false,
            responsive: [ { breakpoint: 870, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: true, dots: false,vertical:false } }
            , { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2 } }
            , { breakpoint: 480, settings: { slidesToShow: 2, slidesToScroll: 2 } }]
        });
         <?php /*$('.rundt1').slick({
            lazyLoad: 'progressive', infinite: true, accessibility:false, vertical:true, slidesToShow: 3,  
            slidesToScroll: 3, autoplay:true,  autoplaySpeed:3000, speed:1000, arrows:false, 
            centerMode:false,  dots:false,  draggable:true, variableWidth:false,
        });
        $('.rundt2').slick({
        ...
        $('.slider-nav').slick({
          ...
          responsive: [ { breakpoint: 870, settings: { slidesToShow: 3, slidesToScroll: 3, infinite: true, dots: false,vertical:false } }
            , { breakpoint: 600, settings: { slidesToShow: 2, slidesToScroll: 2 } }
            , { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1,vertical:false} }]
    ...
    <script>
        $(document).ready(function() {
            ...
            init_paging('', 'page_noibat', 8, 'product', 'san-pham', 'and noibat>0',2);
            /* phan trang san pham noi bat */
