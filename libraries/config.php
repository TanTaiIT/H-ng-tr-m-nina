<?php
	...
	/* Cấu hình coder */
	define('NN_MSHD','MSHDxxxxxxxxxxxxxxxxxxxxxxxx');
	define('NN_AUTHOR','lethanhson.nina@gmail.com');
	...
	$config = array(
		...
		'googleAPI' => array(
			'recaptcha' => array(
				...
				'sitekey' => '6LemS8wZAAAAAM4CtnkALitXZh_kihuLRh5Kz-_0',
				'secretkey' => '6LemS8wZAAAAALX8k_7_unCGXBO-_wwMU_vFu9Iy'
			)
		),
		'oneSignal' => array(
			'active' => false,
		...
		'license' => array(
			'version' => "7.0.0",
			'powered' => "lethanhson.nina@gmail.com"
		)
	);
